...
double X[N][N][N][N][N][N], Y[N][N][N][N][N][N];		        //N番目のパーティクルの座標[m]
double V[N][N][N][N][N][N];                    //N番目のパーティクル座標におけるロボットの速度[m/s]
double A[N][N][N][N][N][N];                    //N番目のパーティクル座標におけるロボットの加速度[m/s^2]
double ROT[N][N][N][N][N][N];                  //N番目のパーティクル座標におけるロボットの向き[rad]
double ROTV[N][N][N][N][N][N];                 //N番目のパーティクル座標におけるロボットの角速度[rad/s]
double ROTA[N][N][N][N][N][N];                 //N番目のパーティクル座標におけるロボットの角加速度[rad/s^2]
double DIST[N][N][N][N][N][N];                 //N番目のパーティクルの進む距離[m]
double GD[N][N][N][N][N][N];			        //各パーティクルと目標位置の距離[m]
double RISKP[N][N][N][N][N][N];				//各回避軌道経由点候補の衝突リスク値
double RISKT[N][N][N][N][N][N];				//各回避軌道候補の積分リスク値
double PP[N][N][N][N][N][N];					//各回避軌道経由点候補における人間の存在確率
...
int q[N][N][N][N][N][N];				        //安全性評価yes/no=0/1
